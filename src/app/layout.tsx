...
export const metadata: Metadata = {
  title: "ConversAI - Advanced AI Chatbot Platform",  description: "Deploy intelligent AI chatbots that understand context and deliver exceptional customer experiences. 94% user satisfaction, 45% cost reduction. Start free today.",  keywords: ["AI chatbot", "conversational AI", "customer support", "NLP", "chatbot platform"],
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "ConversAI - Advanced AI Chatbot Platform",    description: "Intelligent conversations powered by advanced AI. Transform customer engagement.",    type: "website",    siteName: "ConversAI",    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AKDZQtpZ8HQ73PXRvriXIQYy3m/a-modern-ai-chatbot-interface-with-a-dar-1772406707338-4db8dea7.png",      alt: "ConversAI Platform"
    }]
  },
  twitter: {
    card: "summary_large_image",    title: "ConversAI - Advanced AI Chatbot Platform",    description: "Deploy intelligent AI chatbots in minutes. Enterprise-grade NLP and analytics.",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AKDZQtpZ8HQ73PXRvriXIQYy3m/a-modern-ai-chatbot-interface-with-a-dar-1772406707338-4db8dea7.png"]
  }
};
